...
## Modes
- **Home page:** a demo board that clears itself, with Play, Levels, Daily puzzle and your stats (levels cleared, perfect clears, daily streak).
...
6. **Pick the hardest.** Several candidates are generated. The one that needs the most clearing rounds and starts with the fewest free lines wins.
